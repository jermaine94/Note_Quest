...
public class NoteDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteNoteTextViewBtn = findViewById(R.id.delete_note_text_view_btn); // Initialize the deleteNoteTextViewBtn
        ...
        saveNoteBtn.setOnClickListener((View v) -> {
            saveNote();
        });
    ...
    void saveNote() {
        ...
        saveNoteToFirebase(note); // Pass the 'note' object as an argument.
    }
        ...
        documentReference.set(note).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    // Handle the case where the note save failed.
